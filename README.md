...
Public data only, reproducible from scratch. If public inspection reports are unavailable, a realistic sample dataset is generated by script and documented as such.
...
Données publiques uniquement, reproductible depuis zéro. Si les rapports d'inspection publics ne sont pas disponibles, un jeu d'exemple réaliste est généré par script et documenté comme tel.
